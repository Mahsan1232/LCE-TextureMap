...
void PreStitchedTextureMap::loadUVs()
{
	...
	if(iconType != Icon::TYPE_TERRAIN)
	{
		...
		texturesByName.insert(stringIconMap::value_type(L"ingotNetherite",new SimpleIcon(L"ingotNetherite",slotSize*6,slotSize*14,slotSize*(6+1),slotSize*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"netheriteScrap", new SimpleIcon(L"netheriteScrap", slotSize * 5, slotSize * 14, slotSize * (5 + 1), slotSize * (14 + 1))));
